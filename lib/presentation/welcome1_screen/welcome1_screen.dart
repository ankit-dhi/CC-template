import 'bloc/welcome1_bloc.dart';
import 'models/welcome1_model.dart';
...
class Welcome1Screen extends StatelessWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<Welcome1Bloc>(
        create: (context) =>
            Welcome1Bloc(Welcome1State(welcome1ModelObj: Welcome1Model()))
              ..add(Welcome1InitialEvent()),
        child: Welcome1Screen());
  }

  @override
  Widget build(BuildContext context) {
    mediaQueryData = MediaQuery.of(context);
    return BlocBuilder<Welcome1Bloc, Welcome1State>(builder: (context, state) {
      return SafeArea(
          child: Scaffold(
            ...
            Align(
                ...
                child: SizedBox(
                    ...
                    child: Stack(alignment: Alignment.center, children: [
                      CustomImageView(
                          imagePath: ImageConstant.imgEllipse13492x414,
                          height: 492.v,
                          width: 414.h,
                          ...
                          child: SizedBox(
                              ...
                              child: Stack(
                                  ...
                                  children: [
                                    CustomImageView(
                                        imagePath:
                                            ImageConstant.imgEllipse12422x414,
                                        height: 422.v,
                                        width: 414.h,
                                        alignment: Alignment.center),
                                    Align(
  ...
  /// Navigates to the chooseTopic1Screen when the action is triggered.
  onTapGetStartedButton(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.chooseTopic1Screen,
    );
  }
}
