import '../sleep_music3_screen/widgets/sleepmusic3_item_widget.dart';
import 'bloc/sleep_music3_bloc.dart';
import 'models/sleep_music3_model.dart';
...
class SleepMusic3Screen extends StatelessWidget {
  SleepMusic3Screen({Key? key}) : super(key: key);

  GlobalKey<NavigatorState> navigatorKey = GlobalKey();

  static Widget builder(BuildContext context) {
    return BlocProvider<SleepMusic3Bloc>(
        create: (context) => SleepMusic3Bloc(
            SleepMusic3State(sleepMusic3ModelObj: SleepMusic3Model()))
          ..add(SleepMusic3InitialEvent()),
        child: SleepMusic3Screen());
  }
  ...
  Widget _buildSleepMusic(BuildContext context) {
    return BlocSelector<SleepMusic3Bloc, SleepMusic3State, SleepMusic3Model?>(
        selector: (state) => state.sleepMusic3ModelObj,
        builder: (context, sleepMusic3ModelObj) {
          return GridView.builder(
              ...
              itemCount: sleepMusic3ModelObj?.sleepmusic3ItemList.length ?? 0,
              itemBuilder: (context, index) {
                Sleepmusic3ItemModel model =
                    sleepMusic3ModelObj?.sleepmusic3ItemList[index] ??
                        Sleepmusic3ItemModel();
                return Sleepmusic3ItemWidget(model);
              });
        });
  }
