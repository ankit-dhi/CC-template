import 'bloc/welcome_sleep2_bloc.dart';
import 'models/welcome_sleep2_model.dart';
...
class WelcomeSleep2Screen extends StatelessWidget {
  const WelcomeSleep2Screen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<WelcomeSleep2Bloc>(
        create: (context) => WelcomeSleep2Bloc(
            WelcomeSleep2State(welcomeSleep2ModelObj: WelcomeSleep2Model()))
          ..add(WelcomeSleep2InitialEvent()),
        child: WelcomeSleep2Screen());
  }

  @override
  Widget build(BuildContext context) {
    mediaQueryData = MediaQuery.of(context);
    return BlocBuilder<WelcomeSleep2Bloc, WelcomeSleep2State>(
  ...
  /// Navigates to the sleep2Screen when the action is triggered.
  onTapGetStartedButton(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.sleep2Screen,
    );
  }
}
