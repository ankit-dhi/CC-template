import 'bloc/welcome_sleep3_bloc.dart';
import 'models/welcome_sleep3_model.dart';
...
class WelcomeSleep3Screen extends StatelessWidget {
  const WelcomeSleep3Screen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<WelcomeSleep3Bloc>(
        create: (context) => WelcomeSleep3Bloc(
            WelcomeSleep3State(welcomeSleep3ModelObj: WelcomeSleep3Model()))
          ..add(WelcomeSleep3InitialEvent()),
        child: WelcomeSleep3Screen());
  }

  @override
  Widget build(BuildContext context) {
    mediaQueryData = MediaQuery.of(context);
    return BlocBuilder<WelcomeSleep3Bloc, WelcomeSleep3State>(
  ...
  /// Navigates to the sleep3Screen when the action is triggered.
  onTapGetStartedButton(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.sleep3Screen,
    );
  }
}
