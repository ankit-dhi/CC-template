import '../sleep3_screen/widgets/sleep6_item_widget.dart';
import '../sleep3_screen/widgets/sleep7_item_widget.dart';
import 'bloc/sleep3_bloc.dart';
import 'models/sleep3_model.dart';
...
class Sleep3Screen extends StatelessWidget {
  Sleep3Screen({Key? key})
      : super(
          key: key,
        );
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<Sleep3Bloc>(
      create: (context) => Sleep3Bloc(Sleep3State(
        sleep3ModelObj: Sleep3Model(),
      ))
        ..add(Sleep3InitialEvent()),
      child: Sleep3Screen(),
    );
  }
      ...
      child: Stack(
        ...
        children: [
          ...
          Align(
            ...
            child: SizedBox(
              height: 281.v,
              child: BlocSelector<Sleep3Bloc, Sleep3State, Sleep3Model?>(
                selector: (state) => state.sleep3ModelObj,
                builder: (context, sleep3ModelObj) {
                  return ListView.separated(
                    ...
                    itemCount: sleep3ModelObj?.sleep6ItemList.length ?? 0,
                    itemBuilder: (context, index) {
                      Sleep6ItemModel model =
                          sleep3ModelObj?.sleep6ItemList[index] ??
                              Sleep6ItemModel();
                      return Sleep6ItemWidget(
                        model,
                      );
                    },
                  );
  ...
  Widget _buildSleep(BuildContext context) {
    return BlocSelector<Sleep3Bloc, Sleep3State, Sleep3Model?>(
      selector: (state) => state.sleep3ModelObj,
      builder: (context, sleep3ModelObj) {
        return GridView.builder(
          ...
          itemCount: sleep3ModelObj?.sleep7ItemList.length ?? 0,
          itemBuilder: (context, index) {
            Sleep7ItemModel model =
                sleep3ModelObj?.sleep7ItemList[index] ?? Sleep7ItemModel();
            return Sleep7ItemWidget(
              model,
            );
          },
        );
