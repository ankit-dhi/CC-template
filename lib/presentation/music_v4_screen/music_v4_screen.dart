import 'bloc/music_v4_bloc.dart';
import 'models/music_v4_model.dart';
import 'package:ankit_s_application110/core/app_export.dart';
import 'package:ankit_s_application110/widgets/custom_icon_button.dart';
import 'package:flutter/material.dart';

class MusicV4Screen extends StatelessWidget {
  const MusicV4Screen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<MusicV4Bloc>(
        create: (context) =>
            MusicV4Bloc(MusicV4State(musicV4ModelObj: MusicV4Model()))
              ..add(MusicV4InitialEvent()),
        child: MusicV4Screen());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<MusicV4Bloc, MusicV4State>(builder: (context, state) {
      return SafeArea(
          child: Scaffold(
                      ...
                      child: SizedBox(
                          ...
                          child: Stack(
                              ...
                              children: [
                                ...
                                CustomImageView(
                                    imagePath: ImageConstant.imgEllipse461,
                                    height: 180.v,
                                    width: 185.h,
                                    alignment: Alignment.topLeft),
                                CustomImageView(
                                    imagePath: ImageConstant.imgEllipse471,
                                    height: 266.v,
                                    width: 179.h,
                                    alignment: Alignment.bottomRight)
                              ]))))));
