import 'bloc/music2_bloc.dart';
import 'models/music2_model.dart';
import 'package:ankit_s_application110/core/app_export.dart';
import 'package:ankit_s_application110/widgets/custom_icon_button.dart';
import 'package:flutter/material.dart';

class Music2Screen extends StatelessWidget {
  const Music2Screen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<Music2Bloc>(
        create: (context) =>
            Music2Bloc(Music2State(music2ModelObj: Music2Model()))
              ..add(Music2InitialEvent()),
        child: Music2Screen());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<Music2Bloc, Music2State>(builder: (context, state) {
      return SafeArea(
          child: Scaffold(
