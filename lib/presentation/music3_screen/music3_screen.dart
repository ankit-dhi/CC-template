import 'bloc/music3_bloc.dart';
import 'models/music3_model.dart';
import 'package:ankit_s_application110/core/app_export.dart';
import 'package:ankit_s_application110/widgets/custom_icon_button.dart';
import 'package:flutter/material.dart';

class Music3Screen extends StatelessWidget {
  const Music3Screen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<Music3Bloc>(
        create: (context) =>
            Music3Bloc(Music3State(music3ModelObj: Music3Model()))
              ..add(Music3InitialEvent()),
        child: Music3Screen());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<Music3Bloc, Music3State>(builder: (context, state) {
      return SafeArea(
          child: Scaffold(
  ...
  /// Section Widget
  Widget _buildIconButtonStack(BuildContext context) {
  ...
  /// Section Widget
  Widget _buildDownloadStack(BuildContext context) {
    return CustomIconButton(
        height: 55.adaptSize,
        width: 55.adaptSize,
        padding: EdgeInsets.all(18.h),
