import '../reminders_screen/widgets/chipviewsection_item_widget.dart';
...
class RemindersScreen extends StatelessWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<RemindersBloc>(
        create: (context) =>
            RemindersBloc(RemindersState(remindersModelObj: RemindersModel()))
  ...
  Widget _buildChipViewSection(BuildContext context) {
    return Align(
        alignment: Alignment.center,
        child: BlocSelector<RemindersBloc, RemindersState, RemindersModel?>(
            selector: (state) => state.remindersModelObj,
            builder: (context, remindersModelObj) {
              return Wrap(
                  runSpacing: 14.75.v,
                  spacing: 14.75.h,
                  children: List<Widget>.generate(
                      remindersModelObj?.chipviewsectionItemList.length ?? 0,
                      (index) {
                    ChipviewsectionItemModel model =
                        remindersModelObj?.chipviewsectionItemList[index] ??
