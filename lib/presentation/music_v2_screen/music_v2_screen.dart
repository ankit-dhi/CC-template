import 'bloc/music_v2_bloc.dart';
import 'models/music_v2_model.dart';
...
class MusicV2Screen extends StatelessWidget {
  const MusicV2Screen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<MusicV2Bloc>(
        create: (context) =>
            MusicV2Bloc(MusicV2State(musicV2ModelObj: MusicV2Model()))
              ..add(MusicV2InitialEvent()),
        child: MusicV2Screen());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<MusicV2Bloc, MusicV2State>(builder: (context, state) {
      return SafeArea(
          child: Scaffold(
