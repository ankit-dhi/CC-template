import '../sleep_music2_screen/widgets/sleepmusic2_item_widget.dart';
import 'bloc/sleep_music2_bloc.dart';
import 'models/sleep_music2_model.dart';
...
class SleepMusic2Screen extends StatelessWidget {
  SleepMusic2Screen({Key? key}) : super(key: key);

  GlobalKey<NavigatorState> navigatorKey = GlobalKey();

  static Widget builder(BuildContext context) {
    return BlocProvider<SleepMusic2Bloc>(
        create: (context) => SleepMusic2Bloc(
            SleepMusic2State(sleepMusic2ModelObj: SleepMusic2Model()))
          ..add(SleepMusic2InitialEvent()),
        child: SleepMusic2Screen());
  }
  ...
  Widget _buildSleepMusic(BuildContext context) {
    return BlocSelector<SleepMusic2Bloc, SleepMusic2State, SleepMusic2Model?>(
        selector: (state) => state.sleepMusic2ModelObj,
        builder: (context, sleepMusic2ModelObj) {
          return GridView.builder(
              ...
              itemCount: sleepMusic2ModelObj?.sleepmusic2ItemList.length ?? 0,
              itemBuilder: (context, index) {
                Sleepmusic2ItemModel model =
                    sleepMusic2ModelObj?.sleepmusic2ItemList[index] ??
                        Sleepmusic2ItemModel();
                return Sleepmusic2ItemWidget(model);
              });
        });
  }
