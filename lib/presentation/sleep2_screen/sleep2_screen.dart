import '../sleep2_screen/widgets/sleep4_item_widget.dart';
import '../sleep2_screen/widgets/sleep5_item_widget.dart';
import 'bloc/sleep2_bloc.dart';
import 'models/sleep2_model.dart';
...
class Sleep2Screen extends StatelessWidget {
  Sleep2Screen({Key? key})
      : super(
          key: key,
        );
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<Sleep2Bloc>(
      create: (context) => Sleep2Bloc(Sleep2State(
        sleep2ModelObj: Sleep2Model(),
      ))
        ..add(Sleep2InitialEvent()),
      child: Sleep2Screen(),
    );
  }
      ...
      child: Stack(
        ...
        children: [
          ...
          Align(
            ...
            child: SizedBox(
              height: 281.v,
              child: BlocSelector<Sleep2Bloc, Sleep2State, Sleep2Model?>(
                selector: (state) => state.sleep2ModelObj,
                builder: (context, sleep2ModelObj) {
                  return ListView.separated(
                    ...
                    itemCount: sleep2ModelObj?.sleep4ItemList.length ?? 0,
                    itemBuilder: (context, index) {
                      Sleep4ItemModel model =
                          sleep2ModelObj?.sleep4ItemList[index] ??
                              Sleep4ItemModel();
                      return Sleep4ItemWidget(
                        model,
                      );
                    },
                  );
  ...
  Widget _buildSleep(BuildContext context) {
    return BlocSelector<Sleep2Bloc, Sleep2State, Sleep2Model?>(
      selector: (state) => state.sleep2ModelObj,
      builder: (context, sleep2ModelObj) {
        return GridView.builder(
          ...
          itemCount: sleep2ModelObj?.sleep5ItemList.length ?? 0,
          itemBuilder: (context, index) {
            Sleep5ItemModel model =
                sleep2ModelObj?.sleep5ItemList[index] ?? Sleep5ItemModel();
            return Sleep5ItemWidget(
              model,
            );
          },
        );
