import 'bloc/welcome2_bloc.dart';
import 'models/welcome2_model.dart';
...
class Welcome2Screen extends StatelessWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<Welcome2Bloc>(
        create: (context) =>
            Welcome2Bloc(Welcome2State(welcome2ModelObj: Welcome2Model()))
              ..add(Welcome2InitialEvent()),
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<Welcome2Bloc, Welcome2State>(builder: (context, state) {
      return SafeArea(
          child: Scaffold(
  ...
  /// Navigates to the chooseTopic2Screen when the action is triggered.
  onTapGetStartedButton(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.chooseTopic2Screen,
    );
  }
}
