...
class Coursedetails1ItemWidget extends StatelessWidget {
  Coursedetails1ItemWidget(
    this.coursedetails1ItemModelObj, {
    Key? key,
    this.onTapVector,
  }) : super(
          key: key,
  ...
  Coursedetails1ItemModel coursedetails1ItemModelObj;
