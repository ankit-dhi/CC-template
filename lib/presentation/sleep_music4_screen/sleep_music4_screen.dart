import '../sleep_music4_screen/widgets/sleepmusic4_item_widget.dart';
import 'bloc/sleep_music4_bloc.dart';
import 'models/sleep_music4_model.dart';
...
class SleepMusic4Screen extends StatelessWidget {
  SleepMusic4Screen({Key? key}) : super(key: key);

  GlobalKey<NavigatorState> navigatorKey = GlobalKey();

  static Widget builder(BuildContext context) {
    return BlocProvider<SleepMusic4Bloc>(
        create: (context) => SleepMusic4Bloc(
            SleepMusic4State(sleepMusic4ModelObj: SleepMusic4Model()))
          ..add(SleepMusic4InitialEvent()),
        child: SleepMusic4Screen());
  }
  ...
  Widget _buildSleepMusic(BuildContext context) {
    return BlocSelector<SleepMusic4Bloc, SleepMusic4State, SleepMusic4Model?>(
        selector: (state) => state.sleepMusic4ModelObj,
        builder: (context, sleepMusic4ModelObj) {
          return GridView.builder(
              ...
              itemCount: sleepMusic4ModelObj?.sleepmusic4ItemList.length ?? 0,
              itemBuilder: (context, index) {
                Sleepmusic4ItemModel model =
                    sleepMusic4ModelObj?.sleepmusic4ItemList[index] ??
                        Sleepmusic4ItemModel();
                return Sleepmusic4ItemWidget(model);
              });
        });
  }
