import 'bloc/sign_in4_bloc.dart';
import 'models/sign_in4_model.dart';
...
class SignIn4Screen extends StatelessWidget {
  SignIn4Screen({Key? key}) : super(key: key);

  GlobalKey<FormState> _formKey = GlobalKey<FormState>();

  static Widget builder(BuildContext context) {
    return BlocProvider<SignIn4Bloc>(
        create: (context) =>
            SignIn4Bloc(SignIn4State(signIn4ModelObj: SignIn4Model()))
              ..add(SignIn4InitialEvent()),
        child: SignIn4Screen());
  }
            ...
            body: Form(
                ...
                child: Container(
                    ...
                    child: Column(children: [
                      ...
                      _buildEmail(context),
                      SizedBox(height: 20.v),
                      BlocSelector<SignIn4Bloc, SignIn4State,
  ...
  Widget _buildEmail(BuildContext context) {
    return BlocSelector<SignIn4Bloc, SignIn4State, TextEditingController?>(
  ...
  /// Navigates to the signUp4Screen when the action is triggered.
  onTapLogin(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.signUp4Screen,
    );
  }
}
