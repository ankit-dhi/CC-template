import 'bloc/sign_up4_bloc.dart';
import 'models/sign_up4_model.dart';
...
class SignUp4Screen extends StatelessWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<SignUp4Bloc>(
        create: (context) =>
            SignUp4Bloc(SignUp4State(signUp4ModelObj: SignUp4Model()))
              ..add(SignUp4InitialEvent()),
        child: SignUp4Screen());
  }
  ...
  Widget _buildVectorNine(BuildContext context) {
    return BlocSelector<SignUp4Bloc, SignUp4State, TextEditingController?>(
  ...
  Widget _buildIHaveReadThePrivacePolicy(BuildContext context) {
    return Padding(
        ...
        child: BlocSelector<SignUp4Bloc, SignUp4State, bool?>(
