              ...
              child: BlocSelector<SleepBloc, SleepState, SleepModel?>(
                ...
                builder: (context, sleepModelObj) {
                  return ListView.separated(
                    ...
                    itemCount: sleepModelObj?.sleepItemList.length ?? 0,
                    itemBuilder: (context, index) {
                      SleepItemModel model =
                          sleepModelObj?.sleepItemList[index] ??
                              SleepItemModel();
    ...
    return BlocSelector<SleepBloc, SleepState, SleepModel?>(
      ...
      builder: (context, sleepModelObj) {
        return GridView.builder(
          ...
          itemCount: sleepModelObj?.sleep1ItemList.length ?? 0,
          itemBuilder: (context, index) {
            Sleep1ItemModel model =
                sleepModelObj?.sleep1ItemList[index] ?? Sleep1ItemModel();
