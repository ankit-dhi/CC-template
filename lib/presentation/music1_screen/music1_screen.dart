import 'bloc/music1_bloc.dart';
import 'models/music1_model.dart';
import 'package:ankit_s_application110/core/app_export.dart';
import 'package:ankit_s_application110/widgets/custom_icon_button.dart';
import 'package:flutter/material.dart';

class Music1Screen extends StatelessWidget {
  const Music1Screen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<Music1Bloc>(
        create: (context) =>
            Music1Bloc(Music1State(music1ModelObj: Music1Model()))
              ..add(Music1InitialEvent()),
        child: Music1Screen());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<Music1Bloc, Music1State>(builder: (context, state) {
      return SafeArea(
          child: Scaffold(
