import 'bloc/welcome_sleep1_bloc.dart';
import 'models/welcome_sleep1_model.dart';
...
class WelcomeSleep1Screen extends StatelessWidget {
  const WelcomeSleep1Screen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<WelcomeSleep1Bloc>(
        create: (context) => WelcomeSleep1Bloc(
            WelcomeSleep1State(welcomeSleep1ModelObj: WelcomeSleep1Model()))
          ..add(WelcomeSleep1InitialEvent()),
        child: WelcomeSleep1Screen());
  }

  @override
  Widget build(BuildContext context) {
    mediaQueryData = MediaQuery.of(context);
    return BlocBuilder<WelcomeSleep1Bloc, WelcomeSleep1State>(
  ...
  /// Navigates to the sleep1Screen when the action is triggered.
  onTapGetStartedButton(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.sleep1Screen,
    );
  }
}
