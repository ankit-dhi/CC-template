...
class Sleep8ItemWidget extends StatelessWidget {
  Sleep8ItemWidget(
    this.sleep8ItemModelObj, {
    Key? key,
  }) : super(
          key: key,
        );

  Sleep8ItemModel sleep8ItemModelObj;
            ...
            children: [
              CustomIconButton(
                ...
                child: CustomImageView(
                  imagePath: sleep8ItemModelObj?.iconButton,
                ),
              ),
              SizedBox(height: 8.v),
              Text(
                sleep8ItemModelObj.all!,
