import 'bloc/welcome_sleep4_bloc.dart';
import 'models/welcome_sleep4_model.dart';
...
class WelcomeSleep4Screen extends StatelessWidget {
  const WelcomeSleep4Screen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<WelcomeSleep4Bloc>(
        create: (context) => WelcomeSleep4Bloc(
            WelcomeSleep4State(welcomeSleep4ModelObj: WelcomeSleep4Model()))
          ..add(WelcomeSleep4InitialEvent()),
        child: WelcomeSleep4Screen());
  }

  @override
  Widget build(BuildContext context) {
    mediaQueryData = MediaQuery.of(context);
    return BlocBuilder<WelcomeSleep4Bloc, WelcomeSleep4State>(
  ...
  /// Navigates to the sleep4Screen when the action is triggered.
  onTapGetStartedButton(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.sleep4Screen,
    );
  }
}
