import 'bloc/music_v5_bloc.dart';
import 'models/music_v5_model.dart';
import 'package:ankit_s_application110/core/app_export.dart';
import 'package:ankit_s_application110/widgets/custom_icon_button.dart';
import 'package:flutter/material.dart';

class MusicV5Screen extends StatelessWidget {
  const MusicV5Screen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<MusicV5Bloc>(
        create: (context) =>
            MusicV5Bloc(MusicV5State(musicV5ModelObj: MusicV5Model()))
              ..add(MusicV5InitialEvent()),
        child: MusicV5Screen());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<MusicV5Bloc, MusicV5State>(builder: (context, state) {
      return SafeArea(
          child: Scaffold(
                      ...
                      child: SizedBox(
                          ...
                          child: Stack(
                              ...
                              children: [
                                ...
                                CustomImageView(
                                    imagePath: ImageConstant.imgEllipse462,
                                    height: 180.v,
                                    width: 185.h,
                                    alignment: Alignment.topLeft),
                                CustomImageView(
  ...
  /// Section Widget
  Widget _buildRefreshColumn(BuildContext context) {
    return Align(
        alignment: Alignment.bottomLeft,
        child: Padding(
                      ...
                      children: [
                        Padding(
                            ...
                            child: _buildRefresh(context,
                                image: ImageConstant.imgRefresh,
                                text: "lbl_15".tr)),
                        CustomImageView(
                        ...
                        Padding(
                            ...
                            child: _buildRefresh(context,
                                image: ImageConstant.imgRefreshBlueGray300,
                                text: "lbl_15".tr))
                      ])),
