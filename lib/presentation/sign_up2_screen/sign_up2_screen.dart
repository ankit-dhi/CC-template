import 'bloc/sign_up2_bloc.dart';
import 'models/sign_up2_model.dart';
...
class SignUp2Screen extends StatelessWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<SignUp2Bloc>(
        create: (context) =>
            SignUp2Bloc(SignUp2State(signUp2ModelObj: SignUp2Model()))
              ..add(SignUp2InitialEvent()),
        child: SignUp2Screen());
  }
  ...
  Widget _buildVectorNine(BuildContext context) {
    return BlocSelector<SignUp2Bloc, SignUp2State, TextEditingController?>(
  ...
  Widget _buildIHaveReadThePrivacePolicy(BuildContext context) {
    return Padding(
        ...
        child: BlocSelector<SignUp2Bloc, SignUp2State, bool?>(
