import 'bloc/sign_up1_bloc.dart';
import 'models/sign_up1_model.dart';
...
class SignUp1Screen extends StatelessWidget {
  ...
  Widget _buildCreateYourAccount(BuildContext context) {
    return BlocSelector<SignUp1Bloc, SignUp1State, TextEditingController?>(
  ...
  Widget _buildIHaveReadThePrivacePolicy(BuildContext context) {
    return Padding(
        ...
        child: BlocSelector<SignUp1Bloc, SignUp1State, bool?>(
