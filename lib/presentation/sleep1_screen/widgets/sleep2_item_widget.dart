...
class Sleep2ItemWidget extends StatelessWidget {
  Sleep2ItemWidget(
    this.sleep2ItemModelObj, {
    Key? key,
  }) : super(
          key: key,
        );

  Sleep2ItemModel sleep2ItemModelObj;
            ...
            children: [
              CustomIconButton(
                ...
                child: CustomImageView(
                  imagePath: sleep2ItemModelObj?.iconButton,
                ),
              ),
              SizedBox(height: 8.v),
              Text(
                sleep2ItemModelObj.all!,
