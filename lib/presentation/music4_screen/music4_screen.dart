import 'bloc/music4_bloc.dart';
import 'models/music4_model.dart';
import 'package:ankit_s_application110/core/app_export.dart';
import 'package:ankit_s_application110/widgets/custom_icon_button.dart';
import 'package:flutter/material.dart';

class Music4Screen extends StatelessWidget {
  const Music4Screen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<Music4Bloc>(
        create: (context) =>
            Music4Bloc(Music4State(music4ModelObj: Music4Model()))
              ..add(Music4InitialEvent()),
        child: Music4Screen());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<Music4Bloc, Music4State>(builder: (context, state) {
      return SafeArea(
          child: Scaffold(
  ...
  /// Section Widget
  Widget _buildIconButton1(BuildContext context) {
  ...
  /// Section Widget
  Widget _buildIconButton2(BuildContext context) {
    return CustomIconButton(
        height: 55.adaptSize,
        width: 55.adaptSize,
        padding: EdgeInsets.all(18.h),
  ...
  /// Section Widget
  Widget _buildIconButton3(BuildContext context) {
    return Padding(
                      ...
                      children: [
                        Padding(
                            ...
                            child: _buildRefresh(context,
                                image: ImageConstant.imgVectorIndigo5039x38,
                                text: "lbl_15".tr)),
                        CustomImageView(
                        ...
                        Padding(
                            padding: EdgeInsets.symmetric(vertical: 35.v),
                            child: _buildRefresh(context,
                                image: ImageConstant.imgRefreshIndigo50,
                                text: "lbl_15".tr))
                      ])),
  ...
  onTapBtnIconButton3(BuildContext context) {
