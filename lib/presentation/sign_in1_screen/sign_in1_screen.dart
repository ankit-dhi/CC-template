import 'bloc/sign_in1_bloc.dart';
import 'models/sign_in1_model.dart';
...
class SignIn1Screen extends StatelessWidget {
  SignIn1Screen({Key? key}) : super(key: key);

  GlobalKey<FormState> _formKey = GlobalKey<FormState>();

  static Widget builder(BuildContext context) {
    return BlocProvider<SignIn1Bloc>(
        create: (context) =>
            SignIn1Bloc(SignIn1State(signIn1ModelObj: SignIn1Model()))
              ..add(SignIn1InitialEvent()),
        child: SignIn1Screen());
  }
            ...
            body: Form(
                ...
                child: Container(
                    ...
                    child: Column(children: [
                      ...
                      _buildOrLoginWithEmail(context),
                      SizedBox(height: 20.v),
                      BlocSelector<SignIn1Bloc, SignIn1State,
                              TextEditingController?>(
                          selector: (state) => state.spacerController,
                          builder: (context, spacerController) {
  ...
  /// Section Widget
  Widget _buildOrLoginWithEmail(BuildContext context) {
    return BlocSelector<SignIn1Bloc, SignIn1State, TextEditingController?>(
        selector: (state) => state.orLoginWithEmailController,
        builder: (context, orLoginWithEmailController) {
          return CustomTextFormField(
              controller: orLoginWithEmailController,
  ...
  /// Navigates to the signUp1Screen when the action is triggered.
  onTapLogin(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.signUp1Screen,
    );
  }
}
