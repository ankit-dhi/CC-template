import 'bloc/sign_in3_bloc.dart';
import 'models/sign_in3_model.dart';
...
class SignIn3Screen extends StatelessWidget {
  SignIn3Screen({Key? key}) : super(key: key);

  GlobalKey<FormState> _formKey = GlobalKey<FormState>();

  static Widget builder(BuildContext context) {
    return BlocProvider<SignIn3Bloc>(
        create: (context) =>
            SignIn3Bloc(SignIn3State(signIn3ModelObj: SignIn3Model()))
              ..add(SignIn3InitialEvent()),
        child: SignIn3Screen());
  }
            ...
            body: Form(
                ...
                child: Container(
                    ...
                    child: Column(children: [
                      ...
                      _buildEmail(context),
                      SizedBox(height: 20.v),
                      BlocSelector<SignIn3Bloc, SignIn3State,
  ...
  Widget _buildEmail(BuildContext context) {
    return BlocSelector<SignIn3Bloc, SignIn3State, TextEditingController?>(
  ...
  /// Navigates to the signUp3Screen when the action is triggered.
  onTapLogin(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.signUp3Screen,
    );
  }
}
