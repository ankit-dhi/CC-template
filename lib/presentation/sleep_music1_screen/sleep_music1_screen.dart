import '../sleep_music1_screen/widgets/sleepmusic1_item_widget.dart';
import 'bloc/sleep_music1_bloc.dart';
import 'models/sleep_music1_model.dart';
...
class SleepMusic1Screen extends StatelessWidget {
  SleepMusic1Screen({Key? key}) : super(key: key);

  GlobalKey<NavigatorState> navigatorKey = GlobalKey();

  static Widget builder(BuildContext context) {
    return BlocProvider<SleepMusic1Bloc>(
        create: (context) => SleepMusic1Bloc(
            SleepMusic1State(sleepMusic1ModelObj: SleepMusic1Model()))
          ..add(SleepMusic1InitialEvent()),
        child: SleepMusic1Screen());
  }
  ...
  Widget _buildSleepMusic(BuildContext context) {
    return BlocSelector<SleepMusic1Bloc, SleepMusic1State, SleepMusic1Model?>(
        selector: (state) => state.sleepMusic1ModelObj,
        builder: (context, sleepMusic1ModelObj) {
          return GridView.builder(
              ...
              itemCount: sleepMusic1ModelObj?.sleepmusic1ItemList.length ?? 0,
              itemBuilder: (context, index) {
                Sleepmusic1ItemModel model =
                    sleepMusic1ModelObj?.sleepmusic1ItemList[index] ??
                        Sleepmusic1ItemModel();
                return Sleepmusic1ItemWidget(model);
              });
        });
  }
