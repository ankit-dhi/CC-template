import 'bloc/welcome3_bloc.dart';
import 'models/welcome3_model.dart';
...
class Welcome3Screen extends StatelessWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<Welcome3Bloc>(
        create: (context) =>
            Welcome3Bloc(Welcome3State(welcome3ModelObj: Welcome3Model()))
              ..add(Welcome3InitialEvent()),
        child: Welcome3Screen());
  }

  @override
  Widget build(BuildContext context) {
    mediaQueryData = MediaQuery.of(context);
    return BlocBuilder<Welcome3Bloc, Welcome3State>(builder: (context, state) {
      return SafeArea(
          child: Scaffold(
  ...
  /// Navigates to the chooseTopic3Screen when the action is triggered.
  onTapGetStartedButton(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.chooseTopic3Screen,
    );
  }
}
